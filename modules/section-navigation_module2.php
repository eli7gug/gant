<section class="navigation_module section_wrap">
    <?php if(get_sub_field('navigation_module_three_columns')):while(the_repeater_field('navigation_module_three_columns')):  
        ...
        $col3_title_pos = get_sub_field('col2_title_pos');
        ...
        ?>
        <div class="navigation_module_three_cols navigation_module_wrapper">
            ...
            <div class="col_3 col_wrap <?php echo 'text_'.$col3_title_pos; ?>">
                <a href="<?php echo $link3; ?>" title="<?php echo $link2; ?>">
                    <?php if($img3):?>
                        <div class="img_wrapper">
                            <figure>
